...
# wilcox.test(
#   x,
#       Vetor numérico de dados (a amostra observada).
#
#   y = NULL,
#       Segundo vetor numérico de dados. Se fornecido, realiza o
#       teste de Wilcoxon de duas amostras. Se NULL (padrão), realiza o teste de uma amostra ou pareado, dependendo do argumento paired.
#
#   alternative = c("two.sided", "less", "greater"),
#
#   mu = 0,
#       Valor numérico que especifica o parâmetro de locação sob H₀.
#       No teste de uma amostra ou pareado, é o valor de referência da mediana.
#       No teste de duas amostras, é a diferença de locação sob H₀
#
#   paired = FALSE,
#       requer que x e y sejam
#       fornecidos com o mesmo comprimento.
#       Se FALSE e y for fornecido, realiza o teste de
#       Wilcoxon de soma de postos (rank-sum test).
#
#   exact = NULL,
#       Controla o cálculo do p-valor:
#       TRUE  — calcula o p-valor exato com base na distribuição exata dos postos.
#       FALSE — usa a aproximação pela distribuição normal.
#       NULL  — (padrão) escolhe automaticamente: exato se n < 50 e sem empates;
#               caso contrário, usa a aproximação normal.
#
#   correct = TRUE,
#       Se TRUE, aplica a correção de continuidade na
#       aproximação normal. Só tem efeito quando exact = FALSE.
#
#   conf.int = FALSE,
#       Se TRUE, calcula e retorna um intervalo de confiança para o
#       parâmetro de locação (ou diferença de locação no caso de duas amostras),
#       além da estimativa pontual (pseudomediana ou diferença de Hodges-Lehmann).
#
#   conf.level = 0.95,
#       Nível de confiança para o intervalo de confiança. Só tem efeito quando
#       conf.int = TRUE. Valor padrão: 0.95 (intervalo de 95%).
#
#   formula = NULL,
#       Fórmula do tipo y ~ grupo, onde y é a variável resposta numérica e
#       grupo é o fator com dois níveis. Alternativa à especificação direta
#       de x e y.
#
#   data = NULL,
#       Data frame onde as variáveis da fórmula serão buscadas.
#       Só tem efeito quando formula é especificada.
#
#   subset = NULL,
#       Vetor lógico ou numérico opcional para selecionar um subconjunto das
#       observações quando formula é usada.
#
#   na.action = NULL
#       Função que define como lidar com NAs. O padrão segue a opção global
#       getOption("na.action"). Exemplo: na.omit remove os NAs silenciosamente.
# )
```
